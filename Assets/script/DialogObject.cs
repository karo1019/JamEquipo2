...
public class DialogObjeto : MonoBehaviour
{
    ...
    // evento de recogida 
    public event System.Action OnObjetoInteractuado; 
    ...
    private void StartDialogue()
    {
        ...
        Debug.Log(playe.interactionCounter);
    ...
    private void NextLine()
    {
        ...
        else
        {
            ...
            if (!playerHasInteracted && !esPuerta)
            {
                ...
                ++playe.interactionCounter;
                playerHasInteracted = true;

                // msj evento
                OnObjetoInteractuado?.Invoke();
            }
        }
    }
}
